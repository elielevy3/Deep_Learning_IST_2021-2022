...
import os
os.chdir('/home/elie/Documents/Tecnico/2ND_PERIOD/DL/PRACTICAL/Project/Project_1/skeleton_code/')
...
class FeedforwardNetwork(nn.Module):
    def __init__(
        ...
        self.fc4 = torch.nn.Linear(self.hidden_size, n_classes)
...
def train_batch(X, y, model, optimizer, criterion, **kwargs):
    ...
    """
    # predict scores for every class for the given example -> 1 * n_classes
    scores = model(X)
